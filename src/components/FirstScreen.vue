<template>
    <div class="bg-[url('../assets/first-screen-bg.jpg')] bg-cover bg-center w-screen h-screen">
        <div class="px-20 pt-20 max-w-[700px] h-screen text-white
        ...
        ">
            ...
            <div class="mt-6 text-justify">
                ...
                <p class="mt-2">点击加入群聊
                    <a class="pointer-events-auto underline underline-offset-4" href="https://qm.qq.com/q/T0yhPA3GU2" rel="noreferrer noopener" target="_blank">【2024学年北邮人团队招新群】</a></p>
                <p>
